...
有序列表的每个条目结束时，应该用分号，列表最后一行结束时才用句号。
...
注意：不明白什么是全角与半角符号？请查看维基百科词条「[全角和半角](http://zh.wikipedia.org/wiki/%E5%85%A8%E8%A7%92%E5%92%8C%E5%8D%8A%E8%A7%92)」。
...
注意：以下用法略带有个人色彩，既：无论是否遵循下述规则，从语法的角度来讲都是**正确**的。
